...
//	 Use this for initialization
	void Start ()
	{
		myNetworkManager = GameObject.FindGameObjectWithTag("Net Manager").GetComponent<MyNetworkManager>();

		PlayerUsername = myNetworkManager.username;
		print (myNetworkManager.username);
	...
	public void PostChatMessage (string message)
	{
		if (message.Length == 0)
			return;
		var msg = new StringMessage (PlayerUsername + ": " + message);
